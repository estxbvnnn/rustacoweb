...
passport.use(new SteamStrategy({
  returnURL: 'https://www.rustaco.site:3001/auth/steam/return',
  realm: 'https://www.rustaco.site:3001/',
...
app.get('/auth/steam', (req, res, next) => {
  req.headers.host = 'www.rustaco.site:3001';
  next();
...
app.get('/auth/steam/return',
  ...
  (req, res) => {
    if (req.user && req.user.id) {
      // Redirige al frontend usando localhost
